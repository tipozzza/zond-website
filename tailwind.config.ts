  ...
  theme: {
    extend: {
      colors: {
        ...
        // 6 цветов направлений — обновлённый брендбук.
        section: {
          outdoor: "#EF6922",      // Наружная реклама
          print: "#FFFF01",        // Широкоформатная печать (для фоновой заливки, не для текста)
          production: "#85C441",   // Производство
          design: "#1657BD",       // Дизайн и полиграфия
          exhibition: "#00ACEE",   // Выставочные экспозиции
          led: "#67008F",          // Светодиодная продукция
        },
