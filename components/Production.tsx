...
const SLIDES = [
  ...
  },
  {
    ...
    description:
      "Собственный парк сольвентных принтеров Flora, Mimaki, Mustang. Печать на баннере, плёнке, бэклите, сетке, холсте. Ширина до 5 метров — для любых форматов наружной и интерьерной рекламы.",
    features: [
      "Принтеры Flora, Mimaki, Mustang",
      "Ширина печати до 5 м",
