      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            ...
            { question: "Что такое MAXIBIT и JUST?", answer: "MAXIBIT — премиум-класс мобильных выставочных стендов с собственным каркасом и системой освещения. JUST — более бюджетный сегмент с быстрым монтажом от 30 минут. Полная линейка из 12 моделей — на странице." },
