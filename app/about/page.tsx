...
export const metadata: Metadata = {
  title: `О компании ZOND — более 30 лет в Томске | История с 1992`,
  description: `ГК Зонд-Реклама в Томске. более 30 лет работы, 50+ специалистов, 226 рекламных конструкций, собственный цех, дилерство MAXIBIT, бренд Лайтово.`,
  keywords: [
    "Зонд-Реклама",
  ...
  openGraph: {
    ...
    description: `более 30 лет на рынке рекламы Томска — с 1992. 226 конструкций, собственный цех, дилерство MAXIBIT, бренд Лайтово.`,
    ...
    images: [
      {
        url: buildOgUrl({
          title: "О компании ZOND",
          subtitle: `более 30 лет на рынке рекламы Томска — с 1992`,
          category: "О нас",
        }),
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "О компании ZOND",
    description: `более 30 лет на рынке рекламы Томска — с 1992`,
    images: [
      buildOgUrl({
        title: "О компании ZOND",
        subtitle: `более 30 лет на рынке рекламы Томска — с 1992`,
...
const DIFFERENTIATORS = [
  ...
  {
    icon: "🏆",
    title: `более 30 лет на рынке Томска`,
  ...
  },
  {
    ...
    items: [
      ...
      { year: "2025", highlight: true, text: "Ребрендинг 9 отделений «Сбера». Сквер атомщиков. 421-летие Томска. Стела в Парабели. Двусторонний цифровой 3×6 для ОЭЗ. 7 новых цифровых билбордов. «Город IT 2025». «Белозёрский»." },
      {
        ...
        highlight: true,
        text: `Сегодня: более 30 лет на рынке, 226 конструкций, ${SIDES_COUNT} сторон, собственный цех на пр. Фрунзе 109, 50+ специалистов, новый сайт zondreklama.ru.`,
      },
    ],
  },
];
...
const ACHIEVEMENTS = [
  ...
  { icon: "🏭", value: "800 м²", label: "собственный цех на пр. Фрунзе 109" },
];
...
const FAQ_ITEMS = [
  {
    ...
    answer: `С 1992 года, юрлицо — ООО «ФОРМАТ СИТИ». более 30 лет на рынке рекламы и производства в Томске.`,
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да. Офис и шоурум — пр. Фрунзе 115, производственный цех — пр. Фрунзе 109 (через дорогу). По предварительной записи покажем оборудование, материалы, готовые работы. Записаться можно по телефону или через форму.",
  },
  {
    question: "Работаете ли с физлицами?",
    answer:
      "Да, для частных вывесок, праздничного оформления, ивентов. Большая часть оборота — юрлица, но физлица — тоже наши клиенты. Гарантия и качество одинаковые.",
  },
  {
      ...
      <main>
        ...
        <section className="relative bg-slate-900 text-white overflow-hidden">
          ...
          <div className="relative container mx-auto px-4 max-w-5xl py-16 md:py-24">
            ...
            <p className="text-lg md:text-xl text-white/90 mb-8 leading-relaxed max-w-3xl drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] md:drop-shadow-lg">
              более 30 лет создаём рекламу в&nbsp;Томске — от&nbsp;билбордов
        ...
        <section className="py-16 md:py-20 bg-gradient-to-br from-brand/5 to-purple-50">
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
              Что значит «более 30 лет на рынке» — конкретные результаты на сегодня.
            </p>
