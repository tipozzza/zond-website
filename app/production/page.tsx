    ...
    <>
      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            { question: "Сколько стоит вывеска с объёмными буквами в Томске?", answer: "От 25 000 руб за вывеску длиной 2 м с буквами высотой 30 см (акрил с пластиковой подсветкой). Световые буквы с лицевой подсветкой — от 5 000 руб за букву высотой 50 см. Точная смета — по эскизу или фото фасада." },
            ...
            { question: "Делаете ли объёмные буквы любой высоты?", answer: "Изготавливаем буквы от 5 см до 3 метров высотой. До 50 см — стандарт; от 50 см — лазерная резка + ЧПУ-фрезеровка металлической рамы. Максимальная единичная буква — 3 м (для крышных установок и фасадов)." },
