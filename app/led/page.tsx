      ...
      <main>
        ...
        <section id="screens" className="py-12 md:py-20 bg-white scroll-mt-24">
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="text-center mb-12">
              <div className="inline-block bg-[#6F2E91]/10 text-[#6F2E91] text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {SCREEN_TYPES.map((t) => {
                ...
                return (
                  <article
                    key={t.id}
                    className="bg-white rounded-2xl border border-slate-200 hover:border-[#6F2E91] hover:shadow-lg transition-all p-6 flex flex-col"
                  >
                    <div className="w-14 h-14 rounded-2xl bg-[#6F2E91]/10 flex items-center justify-center mb-4">
                      <Icon size={26} className="text-[#6F2E91]" />
                    </div>
                    ...
                    <ul className="text-xs text-slate-600 space-y-0.5 mt-auto pt-2 border-t border-slate-100">
                      {t.applications.map((a) => (
                        <li key={a} className="flex items-start gap-1.5">
                          <span className="text-[#6F2E91]">•</span>
                          {a}
                        </li>
                      ))}
                    </ul>
              ...
              <div className="relative inline-flex gap-0 min-w-full px-4">
                ...
                {HISTORY.map((t) => (
                  <div key={t.year} className="relative flex-shrink-0 w-[200px] text-center">
                    <div className="relative z-10 w-8 h-8 rounded-full bg-[#6F2E91] border-4 border-white shadow-md mx-auto" />
        ...
        <FAQ
          ...
          items={[
            ...
            { question: "С какого месяца лучше заказывать новогоднюю подсветку?", answer: "Оптимально — сентябрь-октябрь. К ноябрю загрузка цеха высокая. В декабре уже сложно успеть смонтировать к 1 декабря. Договор с предоплатой в сентябре гарантирует монтаж до старта сезона." },
            ...
            { question: "Работаете ли вы с управляющими компаниями и ТСЖ?", answer: "Да, выставляем счета на юрлиц, работаем по 44-ФЗ и 223-ФЗ. Есть опыт оформления многоквартирных домов в Томске. Закрывающие документы предоставляем в полном объёме." },
          ]}
        />
