    ...
    <>
      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            { question: "Какая максимальная ширина широкоформатной печати у ZOND?", answer: "3,2 метра по ширине, длина практически не ограничена (до 30 м одним полотном). Печатаем на УФ-сольвентных принтерах Magellan и Flora с разрешением до 1440 dpi." },
            { question: "Какой минимальный заказ для широкоформатной печати?", answer: "Минимального заказа нет — печатаем и 1 м² баннера. На большие тиражи (от 100 м²) действует скидка 10-20%. Срочную печать выполняем в день обращения." },
            { question: "На каких материалах вы печатаете?", answer: "Литой баннер 440-510 г/м², фрезерованный, перфорированный для сеток, винил для плёнки на машины и витрины, бумага, текстиль, холст для интерьерной печати. Полный список — в калькуляторе на странице." },
