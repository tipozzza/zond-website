    ...
    <>
      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            { question: "Где можно увидеть ваши выставочные стенды вживую?", answer: "ZOND — официальный дилер MAXIBIT и JUST с 2006 года. Наши стенды постоянно используются на томских выставках («ТомскЭкспо», «Город IT»). По запросу покажем шоу-рум на пр. Фрунзе 115." },
            { question: "Что такое MAXIBIT и JUST?", answer: "MAXIBIT — премиум-класс мобильных выставочных стендов с собственным каркасом и системой освещения. JUST — более бюджетный сегмент с быстрым монтажом за 30 минут. Полная линейка из 12 моделей — на странице." },
            { question: "Сколько занимает изготовление стенда под ключ?", answer: "Готовый стенд из наличия — 2-3 дня (печать графики + сборка). Эксклюзивная разработка под клиента — 3-4 недели (концепт, согласование, производство, монтаж). Срочные заказы — обсуждаемо." },
            { question: "Делаете ли вы монтаж на выставке?", answer: "Да, наша монтажная бригада выезжает на выставку, собирает стенд за 1-3 часа, демонтирует после окончания. Стоимость монтажа входит в общую смету. По России выезд оплачивается отдельно." },
            { question: "Можно ли арендовать стенд на одну выставку, а не покупать?", answer: "Да, программа аренды: 30-50% от стоимости покупки за 3-дневную выставку. Включает доставку, монтаж, демонтаж. После выставки забираем — у вас не остаётся головной боли с хранением." },
          ]}
        />
