...
const ADVANTAGES: { icon: LucideIcon; stat: string; title: string; text: string }[] = [
  ...
  },
  {
    icon: Map,
    stat: "751",
    title: "751 сторона под управлением",
...
export const metadata: Metadata = {
  title: "Наружная реклама в Томске — 751 сторона, подбор онлайн | Зонд",
  description:
    "Размещение наружной рекламы в Томске: 751 сторона на 226 конструкциях, 348 цифровых LED. Соберите список конструкций по карте и отправьте менеджеру — бронирование онлайн под ключ.",
  keywords: [
  ...
  openGraph: {
    images: [
      {
        url: "/api/og?title=751 сторона наружной рекламы в Томске&subtitle=Билборды и цифровые LED-экраны&category=Наружная реклама",
        width: 1200,
        height: 630,
      },
    ],
  ...
  return (
    <>
      ...
      <ServiceSchema
        ...
        description="751 рекламная сторона на 226 конструкциях: билборды, LED-экраны, сити-форматы, суперсайты."
        lowPrice={9000}
      ...
      <main>
          ...
          <div className="relative z-10 w-full max-w-[1280px] mx-auto px-6 py-24">
            <div className="max-w-xl flex flex-col gap-6 text-white">
              ...
              <p className="text-xl md:text-2xl text-white/90 font-light leading-relaxed drop-shadow">
                751 рекламная сторона на 226 конструкциях, 348 digital.
        ...
        <FAQ
          ...
          items={[
            { question: "Сколько щитов и LED-экранов у ZOND в Томске?", answer: "226 рекламоносителей и 751 сторона. Из них 348 цифровых (LED, тривижн, динамические сити-форматы). Полная карта с фильтрами и онлайн-бронированием — на этой странице." },
