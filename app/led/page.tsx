          ...
          items={[
            {
              ...
              answer:
                "Контур крыши бахромой для дома 10 × 8 м (36 м карниза) — от 16 200 ₽ за материалы в классе «под навес» и от 25 200 ₽ в универсальном IP44. Снежинка на фронтон — от 8 800 ₽, нить на ель во дворе — от 7 300 ₽. Монтаж считаем после замера.",
            },
            {
