...
const STATS = [
  ...
  { value: "18 лет", label: "опыт работы с администрацией (с 2008)" },
];
...
const FAQ_ITEMS = [
  {
    ...
    answer:
      "Штраф 20-100 000 ₽ для юрлиц по статье 9.5.1 КоАП РФ. При повторном нарушении — до 200 000 ₽. Плюс обязательный демонтаж конструкции за счёт владельца. Документальная основа в Томске — Постановление Мэра №362 от 12.05.2008.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Да, по закону можно. На практике без опыта 60-70% заявлений возвращают на доработку — теряется 1-3 месяца. У нас за 18 лет работы — 100% успешных согласований.",
  },
  {
          ...
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl border border-rose-200 shadow-sm">
                ...
                <p className="text-slate-700 text-sm leading-relaxed">
                  20-100 000 ₽ для юрлиц по ст. 9.5.1 КоАП РФ. При повторе — до
