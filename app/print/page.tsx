    ...
    <>
      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            { question: "Какая максимальная ширина широкоформатной печати у ZOND?", answer: "Максимальная ширина запечатываемого поля 3100 мм, ширина рулона материала 3200 мм. Длина практически не ограничена (до 30 м в одном полотнище). Для баннеров больше 3 м делаем склейку из частей, также возможны нестандартные формы. Печатаем на сольвентных принтерах Magellan и Flora с разрешением до 720 dpi. Интерьерный принтер ArcJet даёт до 1440 dpi на холсте, плёнке и бумаге." },
            ...
            { question: "На каких материалах вы печатаете?", answer: "Литой баннер 440-510 г/м², ламинированный 280-340 г/м², баннерная сетка, винил для плёнки на машины и витрины, бумага, текстиль, холст для интерьерной печати. Полный список — в калькуляторе на странице." },
