...
const EQUIPMENT: {
  ...
  {
    // TODO: пришлёт Дмитрий фото Mustang — заменить /images/print/printer-mustang.jpg
    ...
    <>
      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            { question: "Какая максимальная ширина широкоформатной печати у ZOND?", answer: "Максимальная ширина запечатываемого поля 3100 мм, ширина рулона материала 3200 мм. Длина практически не ограничена (до 30 м в одном полотнище). Для баннеров больше 3 м делаем склейку из частей, также возможны нестандартные формы. Печатаем на сольвентных принтерах Magellan и Flora с разрешением до 720 dpi. Интерьерный принтер Mustang даёт до 1440 dpi на холсте, плёнке и бумаге." },
