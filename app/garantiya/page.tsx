...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Гарантийные обязательства привязаны к договору, а не к названию юр.лица. Если ООО «ФОРМАТ СИТИ» реорганизуется — обязательства переходят к правопреемнику. За 17 лет работы ИНН не менялся.",
  },
  {
