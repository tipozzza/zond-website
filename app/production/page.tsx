...
const CATEGORIES: {
  ...
  },
  {
    ...
    description:
      "Подбираем способ монтажа под архитектуру здания: прямой крепёж к фасаду, дистанционные держатели, каркас с отступом от стены, выносные кронштейны, композитная подложка. От монолитных без подсветки до букв с открытыми диодами и контражурным свечением.",
  },
  {
    img: "/images/production/sequin-letters.jpg?v=2",
    title: "Буквы-пайетки",
...
const STEPS = [
  { num: 1, title: "Заявка", text: "Заполняете калькулятор или звоните — обсуждаем задачу." },
  { num: 2, title: "Замер", text: "Выезд специалиста. По Томску — бесплатно." },
  { num: 3, title: "Проект", text: "Визуализация и согласование макета." },
