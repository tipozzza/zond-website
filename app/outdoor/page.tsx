...
export const metadata: Metadata = {
  title: "Наружная реклама в Томске — 726 сторон, подбор онлайн | Зонд",
  description:
    "Размещение наружной рекламы в Томске: 726 сторон на 226 конструкциях, 336 цифровых LED. Соберите список конструкций по карте и отправьте менеджеру — бронирование онлайн под ключ.",
  keywords: [
