...
const TIMELINE = [
  { year: "1992", title: "Основание", desc: "Создание рекламной фирмы «Формат Сити» в Томске. Первая коммерческая сеть рекламных установок в городе." },
  { year: "1995", title: "Первая широкоформатная печать", desc: "Установка первого за Уралом оборудования полноцветной широкоформатной печати — открыли направление широкоформата в регионе." },
  { year: "2000", title: "Освоили рекламные конструкции", desc: "Сборка и монтаж собственных рекламных установок 3×6 м. Первые сити-форматы в центре города." },
  { year: "2006", title: "Дилер MAXIBIT", desc: "Получили сертификат дилера MAXIBIT (Швеция) — премиум выставочное оборудование. Единственные в Сибири." },
  { year: "2007", title: "Первый LED в Томске", desc: "Установили первый цифровой светодиодный видеоэкран на пл. Новособорной. Старт цифровой эры наружки в городе." },
  { year: "2008", title: "Гирлянды и иллюминация", desc: "Запуск направления светодиодной продукции и новогодней иллюминации. Первые крупные объекты с подсветкой фасадов." },
  { year: "2010", title: "Госконтракты по 44-ФЗ", desc: "Начали участвовать в государственных тендерах. Первые контракты с муниципальными и областными заказчиками." },
  { year: "2012", title: "Собственный цех на Фрунзе 115", desc: "Открыли производственный цех на пр. Фрунзе 115 — лазерная резка, ЧПУ-фрезеровка, сборка вывесок под крышей одного здания." },
  { year: "2016", title: "Digital-сеть", desc: "Установка первых цифровых билбордов в центре города — формирование собственной сети ротации." },
  { year: "2018", title: "Парк 200+ конструкций", desc: "Расширили парк до 200+ рекламных конструкций. Покупка принтера Magellan, новых станков металлообработки." },
  { year: "2021", title: "Бренд Лайтово", desc: "Выделение LED-иллюминации в отдельный бренд «Лайтово». Выход на федеральный рынок с фасадной подсветкой." },
  { year: "2023", title: "Обновление оборудования", desc: "Парк УФ-печати Magellan и Flora до 3,2 м. Новый бортогибочный станок, интерьерные принтеры. Расширение цифровой сети." },
  {
    year: String(new Date().getFullYear()),
    title: "Сегодня",
    desc: `${YEARS_ON_MARKET} лет на рынке, 226 конструкций, 726 рекламных сторон, собственный цех на пр. Фрунзе 115, 50+ специалистов, новый сайт zondreklama.ru.`,
  },
];

const ACHIEVEMENTS = [
  { icon: "📺", value: "226", label: "рекламных конструкций / 726 сторон в Томске" },
  { icon: "📡", value: "336", label: "цифровых LED-экранов и тривижн" },
      ...
      <main>
        ...
        <section id="timeline" className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <p className="text-center text-slate-600 mb-12 max-w-2xl mx-auto">
              Тринадцать ключевых вех с 1992 года — что сформировало ZOND таким, какой
              он есть сегодня.
            </p>
