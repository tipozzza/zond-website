...
- `bg-brand`, `text-brand` — основной фирменный #6F395D (брендбук)
- `bg-brand-hover` / `bg-brand-active` — состояния кнопок (#5E2F4F / #4F2542)
- `bg-brand-light` — светлый фон под акцент (#F1E7ED)
