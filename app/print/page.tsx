    ...
    <>
      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            { question: "Какая максимальная ширина широкоформатной печати у ZOND?", answer: "3,2 метра по ширине, длина практически не ограничена (до 30 м одним полотном). Печатаем на сольвентных принтерах Magellan и Flora с разрешением до 1440 dpi." },
