      ...
      <main>
        ...
        <FAQ
          ...
          items={[
            ...
            { question: "Можете напечатать то, что разработали?", answer: "Да, мы — полный цикл: дизайн → печать → монтаж. Для клиентов дизайна — скидка 10% на печать в том же заказе. Это удобно: не нужно бегать между дизайнером и типографией." },
