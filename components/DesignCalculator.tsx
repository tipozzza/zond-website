      ...
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          <div className="p-6 md:p-8 grid md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    {data.brandbook.packages.map((p) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-[#1657BD] font-bold">{formatRub(p.price)}</span>
                        </div>
            ...
            <div className="bg-gradient-to-br from-[#1657BD]/10 to-slate-50 rounded-2xl p-6">
              <div className="text-xs font-semibold uppercase tracking-wider text-slate-500 mb-2">
                Итого
              </div>
              <div className="text-4xl md:text-5xl font-bold text-[#1657BD] mb-6 leading-none">
                {totalDisplay}
              </div>
              ...
              <button
                ...
                className="w-full bg-[#1657BD] hover:bg-[#144DAA] disabled:opacity-50 disabled:cursor-not-allowed text-white py-3.5 rounded-xl font-bold transition flex items-center justify-center gap-2"
              >
                Оформить заявку
                <ArrowRight size={20} />
              </button>
