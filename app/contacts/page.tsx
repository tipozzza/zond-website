...
const CHANNELS = [
  ...
  },
  {
    ...
    desc: "Суббота — по предварительной записи. Воскресенье — выходной. Заявка через сайт принимается 24/7.",
  },
];
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      "Будни — 9:00-18:00. Суббота — 10:00-15:00 по предварительной записи. Воскресенье — выходной. Срочные заявки можно оставить через сайт или Telegram — рассмотрим в первый рабочий день.",
  },
  {
