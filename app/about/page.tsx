...
const HISTORY: HistoryItem[] = [
  ...
  { year: "2009", text: "Внедрение 1С-8. Покупка сольвентного принтера-каттера Mimaki CJV30-160." },
  ...
  { year: "2017", text: "25-летний юбилей. Расширение сети цифровых билбордов до 10 установок. Принтер Mimaki CJV150. Первые рекламные конструкции в Асино." },
