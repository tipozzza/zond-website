  ...
  return (
    <>
      ...
      <main>
        ...
        <FAQ
          items={[
            { question: "Сколько стоит разработка логотипа в Томске?", answer: "Монохромный логотип — от 8 000 ₽, цветной — от 10 000 ₽, комплексный (логотип + лого-бук + базовая фирстиль) — от 15 000 ₽. Включает 3 концепции и до 5 правок." },
            { question: "За сколько разрабатывается логотип?", answer: "Стандартный срок — 7-14 рабочих дней: 2-3 дня на концепции, 3-5 дней на доработку выбранной, 2-3 дня на финал и выгрузку файлов." },
            { question: "Сколько вариантов логотипа я получу?", answer: "На первом этапе — 3 концепции в разных стилистических направлениях. После вашего выбора одной концепции — до 5 правок до финального варианта." },
            { question: "Какие файлы передаёте?", answer: "Векторные исходники: .ai (Adobe Illustrator), .eps, .pdf. Растровые версии: .png с прозрачным фоном в 4 размерах. .svg для веба. Чёрно-белая и инверсная версии." },
            { question: "Делаете ли брендбук?", answer: "Да, 3 пакета: Индивидуальный (20 000 ₽) — логотип + базовые правила; Оптимальный (35 000 ₽) — + фирменный шаблоны; Комплексный (50 000 ₽) — + офисный стиль и интерьерный мерч." },
