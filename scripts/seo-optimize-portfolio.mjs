...
const LED_TEMPLATES = {
  ...
  elka: {
    ...
    descs: [
      "LED-гирлянды тёплого свечения для ёлки 8–15 метров. Направление иллюминации ZOND с 2008 года, бренд «Лайтово» с 2021.",
...
function rewriteDesign(items) {
  ...
  const logosDescs = [
    ...
    "Фирменный стиль для нового бренда: логотип, монохромная и цветная версии, гайдлайны. Согласование с типографией для печати.",
  ];
...
function rewritePrint(items) {
  ...
  const seeds = [
    "Печать на сольвентных принтерах Magellan и Flora, ширина до 3,2 м. Срок 1–3 рабочих дня в Томске, доставка по городу.",
