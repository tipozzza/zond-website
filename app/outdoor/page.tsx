  ...
  return (
    <>
      ...
      <main>
        ...
        <FAQ
          items={[
            { question: "Сколько стоит размещение рекламы в Томске?", answer: "Зависит от формата: сити-формат 1,2×1,8 — от 9 000 ₽/мес, классический щит 3×6 — от 29 000 ₽/мес, тривижн — от 35 000 ₽/мес, цифровой LED-биллборд — от 45 000 ₽/мес, супер-сайт 5×15 — от 75 000 ₽/мес." },
            { question: "Какой минимальный срок размещения?", answer: "На цифровых билбордах — от 1 дня (от 3 000 ₽/сутки). На статичных конструкциях — от 1 месяца (с учётом времени на печать баннера и монтаж). При размещении от 3 месяцев действуют скидки." },
            { question: "Что входит в стоимость размещения?", answer: "Аренда поверхности, регулярная проверка состояния, замена при повреждении по нашей вине. Печать баннера и монтаж — отдельно (от 5 000 ₽ за щит 3×6). Дизайн макета — отдельная услуга." },
            { question: "Как выбрать конкретные конструкции?", answer: "Через интерактивную карту на этой странице. У каждой конструкции — фото, точный адрес, цена, статус занятости по месяцам. Можно отфильтровать по типу, формату, направлению трафика, наличию подсветки." },
            { question: "Делаете ли фотоотчёт после монтажа?", answer: "Да, обязательно. Сразу после монтажа баннера высылаем фото с разных ракурсов (днём и в подсвеченном виде, если конструкция со светом)." },
