...
const TIMELINE: Decade[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { year: "2008", text: "Запуск направления светодиодной иллюминации. Экспозиция для Департамента развития предпринимательства на «ИНТУРМАРКЕТ-2008»." },
  ...
  },
  {
    ...
    items: [
      ...
      { year: "2022", highlight: true, text: "30-летний юбилей ГК. Переоборудование сети под новый фирстиль. Оформление «ГОРОД IT». Ребрендинг ТПУ." },
      ...
      { year: "2025", highlight: true, text: "Ребрендинг 9 отделений «Сбера». Сквер атомщиков. 421-летие Томска. Стела в Парабели. Двусторонний цифровой 3×6 для ОЭЗ. 7 новых цифровых билбордов. «Город IT 2025». «Белозёрский»." },
      {
        ...
        highlight: true,
        text: `Сегодня: ${YEARS_ON_MARKET} лет на рынке, 226 конструкций, 726 сторон, собственный цех на пр. Фрунзе 115, 50+ специалистов, новый сайт zondreklama.ru.`,
      },
    ],
  },
];
