...
export const metadata: Metadata = {
  ...
  description:
    "Наружная реклама, широкоформатная печать, производство вывесок, дизайн и полиграфия в Томске. 726 рекламных сторон, собственный цех. Звоните: 8 (3822) 97-97-05",
  keywords: [
    "реклама Томск",
